...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"p5.sound.min.js":[function(require,module,exports) {
...
!function (n) {
  ...
  void 0 === (i = function () {
    ...
    return l.prototype.set = function (t, e, n) {
      ...
      var e = [];
      if (this.isUndef(t.defaults) || (e = Object.keys(t.defaults)), !this.isUndef(t._super)) for (var n = this._collectDefaults(t._super), i = 0; i < n.length; i++) {
      ...
      if (0 < arguments.length) for (var t = 0; t < arguments.length; t++) {
      ...
      var i = {};
      if (1 === t.length && this.isObject(t[0])) i = t[0];else for (var r = 0; r < e.length; r++) {
        i[e[r]] = t[r];
      }
  ...
  i = [n(0), n(2), n(19)], void 0 === (r = function (u) {
    ...
    return u.TimelineSignal = function () {
      ...
      if (n && n.time === t) this.cancelScheduledValues(t + this.sampleTime);else if (n && n.type === u.TimelineSignal.Type.Curve && n.time + n.duration > t) this.cancelScheduledValues(t), this.linearRampToValueAtTime(e, t);else {
      ...
      if (null === n) i = this._initial;else if (n.type === u.TimelineSignal.Type.Target) {
        var r,
  ...
  i = [n(0), n(14)], void 0 === (r = function (i) {
    function t(t, e, n) {
      if (t.input) Array.isArray(t.input) ? (i.prototype.isUndef(n) && (n = 0), this.connect(t.input[n])) : this.connect(t.input, e, n);else try {
    ...
    return !window.hasOwnProperty("AudioContext") && window.hasOwnProperty("webkitAudioContext") && (window.AudioContext = window.webkitAudioContext), i.Context = function (t) {
      for (var e in i.Emitter.call(this), t = t || new window.AudioContext(), this._context = t, this._context) {
      ...
      if (t && t.input && Array.isArray(t.input)) i.prototype.isUndef(n) && (n = 0), this.disconnect(t.input[n], e, n);else if (t && t.input) this.disconnect(t.input, e, n);else try {
  ...
  i = [n(0)], void 0 === (r = function (s) {
    ...
    return s.Emitter = function () {
      ...
      for (var n = t.split(/\W+/), i = 0; i < n.length; i++) {
        if (t = n[i], this._events.hasOwnProperty(t)) if (s.prototype.isUndef(e)) this._events[t] = [];else for (var r = this._events[t], o = 0; o < r.length; o++) {
          r[o] === e && r.splice(o, 1);
        }
      }
      ...
      if (this._events) {
        ...
        if (this._events.hasOwnProperty(t)) for (var n = this._events[t], i = 0, r = n.length; i < r; i++) {
          n[i].apply(this, e);
        }
      }
  ...
  i = [n(0)], void 0 === (r = function (i) {
    return i.TimeBase = function (t, e) {
      ...
      if (this._expr = this._noOp, t instanceof i.TimeBase) this.copy(t);else if (!this.isUndef(e) || this.isNumber(t)) {
  ...
  r = [], void 0 === (o = "function" == typeof (i = function i() {
    ...
    return s.prototype._moved = function (t) {
      ...
      return function t(e, n, i) {
        if (Array.isArray(e) || NodeList && e instanceof NodeList) for (var r = 0; r < e.length; r++) {
          t(e[r], n, i);
        } else if ("string" == typeof e) t(document.querySelectorAll(e), n, i);else if (e.jquery && "function" == typeof e.toArray) t(e.toArray(), n, i);else if (Element && e instanceof Element) {
          var o = new s(e, i);
          n.push(o);
        }
  ...
  a = [], "function" != typeof AudioWorkletNode && (self.AudioWorkletNode = function (t, e, n) {
    ...
    return fetch(t).then(function (t) {
      ...
      var n = {
        ...
        registerProcessor: function registerProcessor(t, e) {
          h(r.$$context)[t] = {
            realm: i,
            context: n,
            Processor: e,
    ...
    return function (t, e, n) {
      ...
      value: function value() {
        for (var t, e, n = new Array(), i = 0; i < arguments.length; i++) {
          "number" == typeof arguments[i] && (t = arguments[i], this.analyser.fftSize = 2 * t), "string" == typeof arguments[i] && (e = arguments[i]);
        }
      ...
      value: function value() {
        for (var t, e = 0; e < arguments.length; e++) {
          "number" == typeof arguments[e] && (this.bins = arguments[e], this.analyser.fftSize = 2 * this.bins), "string" == typeof arguments[e] && (t = arguments[e]);
        }
  ...
  function $(t, e, n, i, r) {
    ...
    for (var s in t.mathOps) {
      t.mathOps[s] instanceof r && (o.disconnect(), t.mathOps[s].dispose(), (n = s) < t.mathOps.length - 2 && (i = t.mathOps[s + 1]));
    }
  ...
  function st(t) {
    return (st = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (t) {
      return _typeof(t);
    } : function (t) {
      return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : _typeof(t);
    })(t);
  ...
  function Ht(t) {
    return (Ht = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (t) {
      return _typeof(t);
    } : function (t) {
      return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : _typeof(t);
    })(t);
  ...
  var ee = function () {
    function s(t) {
      ...
      for (var o = 0; o < t; o++) {
        r = o === t - 1 ? (i = 21e3, .01) : 0 === o ? (i = 100, .1) : (i = 1 === o ? 3 === t ? 360 * n : 360 : e.bands[o - 1].freq() * n, 1), e.bands[o] = e._newBand(i, r), 0 < o ? e.bands[o - 1].connect(e.bands[o].biquad) : e.input.connect(e.bands[o].biquad);
      }
    ...
    return function (t, e) {
      ...
      key: "set",
      value: function value() {
        if (arguments.length === 2 * this.bands.length) for (var t = 0; t < arguments.length; t += 2) {
  ...
  var ie = function () {
    ...
    return function (t, e, n) {
      ...
      key: "orient",
      value: function value(t, e, n, i, r, o, s) {
  ...
  function re(t) {
    return (re = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (t) {
      return _typeof(t);
    } : function (t) {
      return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : _typeof(t);
    })(t);
  ...
  function he(t) {
    return (he = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (t) {
      return _typeof(t);
    } : function (t) {
      return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : _typeof(t);
    })(t);
  ...
  function _e(t) {
    return (_e = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (t) {
      return _typeof(t);
    } : function (t) {
      return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : _typeof(t);
    })(t);
  ...
  var Ae = function () {
    ...
    return ke(e, Ct), Te(e, [{
      ...
      value: function value() {
        ...
        for (e = 0; e < i; e++) {
          t = this._reverse ? i - e : e, s[e] = (2 * Math.random() - 1) * Math.pow(1 - t / i, r), a[e] = (2 * Math.random() - 1) * Math.pow(1 - t / i, r);
        }
    ...
    return ke(r, Ae), Te(r, [{
      ...
      key: "toggleImpulse",
      value: function value(t) {
        if ("number" == typeof t && t < this.impulses.length && this._setBuffer(this.impulses[t].audioBuffer), "string" == typeof t) for (var e = 0; e < this.impulses.length; e++) {
  ...
  var Fe = function () {
    ...
    return Be(n, [{
      ...
      value: function value(t, e, n) {
        var i;
        if (3 === arguments.length) i = new Me(t, e, n);else {
    ...
    function n() {
      ...
      for (var e in arguments) {
        this.parts[e] = arguments[e], this.parts[e].nextPart = this.parts[e + 1], this.parts[e].onended = function () {
          t.resetPart(e), Ie(t);
        };
      }
  ...
  function Le(t) {
    return (Le = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (t) {
      return _typeof(t);
    } : function (t) {
      return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : _typeof(t);
    })(t);
  ...
  var He = function () {
    ...
    return function (t, e) {
      ...
      key: "process",
      value: function value(t, e, n, i, r, o) {
  ...
  function en(t) {
    return (en = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (t) {
      return _typeof(t);
    } : function (t) {
      return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : _typeof(t);
    })(t);
  ...
  function dn(t) {
    return (dn = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (t) {
      return _typeof(t);
    } : function (t) {
      return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : _typeof(t);
    })(t);
    ...
    return function (t, e, n) {
      ...
      value: function value() {
        for (var t = 0; t < this.maxVoices; t++) {
          this.audiovoices.push(new this.AudioVoice()), this.audiovoices[t].disconnect(), this.audiovoices[t].connect(this.output);
        }
      }
    }, {
      key: "play",
      ...
      value: function value(t, e) {
        ...
        if (t) {
          ...
          t.triggerRelease(i);
        }), this._voicesInUse.setValueAtTime(0, r), this.notes) {
  ...
  p5.prototype.getAudioContext = c.b, p5.prototype.userStartAudio = c.c, p5.prototype.sampleRate = function () {
    ...
    for (var o in t.mathOps) {
      t.mathOps[o] instanceof r && (t.mathOps[o].dispose(), (n = o) < t.mathOps.length - 1 && (i = t.mathOps[o + 1]));
    }
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","p5.sound.min.js"], null)
//# sourceMappingURL=/p5.sound.min.4a04f92a.js.map